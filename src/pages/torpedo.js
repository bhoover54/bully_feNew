  ...
  return (
    <Row>
      <Col xs="12" md="8" className="mx-auto">
        ...
        <p className="">
            The following procedures empowers every adult over 21 years of age, parent or non-parent, with the ability to quickly end any abuse a child is enduring 
        ...
        <p className="">
          ...
          <p className="">
              ...
              Please click <a href="/report-details"><b>HERE</b></a> to see a sample Bully Periscope Report and the valuable information that a Bully Periscope Report provides you.<br />
          ...
          <p className="">
              ...
              one bully to drag the district deep into the legal liability swamp by repeatedly bullying others.
          </p>
          <p className="">
