  ...
  return (
    <Row>
      ...
      <Col md="6" className="d-flex flex-column justify-content-center p-3">
        <h3 className=""> When The Bully Periscope “Torpedoes” a Bully, All Abuse Quickly Ends!<br />
      ...
      <Col md={8} lg={7} className="mx-auto my-3">
        ...
        <p className="">
           The Bully Periscope is a new, parent developed, “super-weapon”, that has been created to bring an end to our long, losing and disastrous war against bullying in our schools. That, in a nutshell, is what The Bully Periscope is.        
        </p>
        <p className="">
        ...
        <p className="">
           If you are a parent, coach or youth leader of any kind, please review the information in the MESSAGES TO MOMS tab, it is vitally important that youth leaders and parents follow the instructions provided there.
        </p> 
        <p className="">
